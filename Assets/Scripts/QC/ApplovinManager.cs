...
public class ApplovinManager : MonoBehaviour
{
    ...
    public void InitAds()
    {
        ...
        MaxSdk.SetSdkKey("7EVycU1osdSTaEELwvilulxoyqzM1zAzQ1bh57evZkZSfTvSdedR0TW5ZIXTa5h3PZUZwPcl6QkvifdwtbwV0d");
        MaxSdk.InitializeSdk();
    }

    #region banner

    public string bannerAdUnitId = "346bc9c2f0b721c4"; // Retrieve the ID from your account
    ...
    public string intertitialAdUnit = "efc7264c672c04bb";
    ...
    public string rewardAdUnit = "771ecadd06c16655";
