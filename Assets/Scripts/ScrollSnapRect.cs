...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    //check chay lan dau scene rua mat thi khong lam mat spa 2
    bool checkFirtSpa = true;
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Confusing setting of horizontal/vertical direction. Default set to horizontal.");
            _horizontal = true;
        }
    ...
    void Update()
    {
        ...
        if (_lerp)
        {
            Debug.Log("Update if moving to target position");
    ...
    //------------------------------------------------------------------------
    public void SetPageSelection(int aPageIndex)
    {
        // nothing to change
        ...
        //------------------------------------------------------------------
        //Debug.Log("SetPageSelection: "+ aPageIndex);
